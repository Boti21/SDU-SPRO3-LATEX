...
%printed to the webpage can be easily decided by the user and adjusted in the ir\\_sensor\\_put\\_web\\-function.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{forkconnect_tekexpo.jpg}
