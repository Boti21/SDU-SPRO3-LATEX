...
\section{Electronics}
    ...
    \subfile{Electronics/ElectronicsIRsensnsors.tex}
    \subfile{Electronics/ElectronicsMultiplexer.tex}
...
\section{Mechanical}
    ...
    \subfile{Mechanical/dynamics.tex}
    
\section{Code}
    Full code can be found here: \url{https://github.com/Boti21/SDU-SPRO3-CODE/tree/dev/SPRO3-Firmware}
    ...
    \subfile{Code/read_battery_voltage.tex}
\section{Testing}
    ...
    \subfile{Management/risk_assessment_finalproduct.tex}
\section{Conclusion}
...
\end{multicols}
\subfile{Management/taskresponsebilities.tex}
